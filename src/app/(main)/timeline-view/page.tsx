...
const TimelineDndStrip = dynamic(
    () => import('@/components/timeline-view/TimelineDndStrip').then((m) => ({ default: m.TimelineDndStrip })),
    {
        ssr: false,
        loading: () => (
            <div className="min-h-[120px] rounded-xl border border-zinc-800/80 bg-zinc-900/30 animate-pulse" aria-hidden />
        ),
    }
)
        ...
        <div className="min-h-full bg-[#000000]">
            <div className="w-full min-w-0 space-y-5 px-4 py-4 sm:px-5 sm:py-5 lg:px-8 lg:py-6 xl:px-10">
                ...
                <div className="flex flex-wrap gap-3">
                    <div className="rounded-xl border border-[#1a1a1a] bg-[#0A0A0C] px-4 py-3 transition-colors hover:border-zinc-700">

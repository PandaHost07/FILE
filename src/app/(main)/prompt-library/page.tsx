...
export default function PromptLibraryPage() {
    ...
    const isCabinProject = activeProject != null && getProjectContentMode(activeProject) === 'cabin_build'
    const filterCategory: TemplateCategory = isCabinProject ? 'cabin' : activeCategory
            ...
            <div className="w-full min-w-0 space-y-6">
                ...
                {activeScene ? (
                    <div className="flex items-center gap-3 rounded-xl border border-amber-500/30 bg-amber-500/5 px-4 py-3 text-sm">
                        ...
                        <span className="text-zinc-500">— Klik &ldquo;Terapkan&rdquo; untuk langsung pakai prompt ke scene ini</span>
                    </div>
                ) : (
                        ...
                        {CATEGORIES.map((cat) => (
                            <button
                                ...
                                className={cn(
                                    ...
                                    (isCabinProject ? cat === 'cabin' : activeCategory === cat)

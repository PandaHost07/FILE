    ...
    return (
        <div className="min-h-screen bg-[#000000] p-6 md:p-10">
            <div className="w-full min-w-0 space-y-6">
                ...
                {/* Project info */}
                <div className="rounded-2xl border border-[#1a1a1a] bg-[#0A0A0C] p-5 space-y-3">
                ...
                {/* Options */}
                {!isRunning && !done && (
                    <div className="rounded-2xl border border-[#1a1a1a] bg-[#0A0A0C] p-5 space-y-4">
                ...
                {(isRunning || done) && progress.length > 0 && (
                    <div className="space-y-4">
                        ...
                        <div className="space-y-2">
                            {progress.map((p) => (
                                <div key={p.sceneId} className="flex items-center gap-3 rounded-xl border border-[#1a1a1a] bg-[#050505] px-4 py-3">

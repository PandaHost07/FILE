...
const TOOL_CARDS: ToolCardItem[] = [
    ...
    },
    {
        href: '/clipper',
        title: 'Clipper',
        desc: 'Potong video, crop 9:16 / 16:9, subtitle burn-in (lokal, FFmpeg.wasm).',
        icon: Scissors,
        badge: 'Video',
    },
]
...
export default function ToolsPage() {
    return (
        <div className="min-h-full bg-zinc-950">
            <div className="w-full min-w-0 space-y-6 px-4 py-5 sm:px-5 sm:py-6 lg:px-8 xl:px-10">

...
import { ImageIcon, Copy, Check, Loader2, Wand2, Save, ChevronDown, ChevronUp } from 'lucide-react'
        ...
        <div className="rounded-xl border border-zinc-800 bg-zinc-900 p-4 space-y-3">
            ...
            <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm font-semibold text-zinc-100">Image Prompt</span>
                </div>
                <button
                    onClick={handleCopy}
                    disabled={!value}
            ...
            <div className="relative">
                <textarea
                    ...
                    rows={6}
                    placeholder="Image prompt akan muncul di sini setelah di-generate..."
